...
def get_raw_customer_data(extract_date: str = None) -> pd.DataFrame: # type: ignore
...
def etl(extract_date: str = None): # type: ignore
    """
    ...
    with duckdb.connect(database=":memory:") as con:
        ...
        con.execute(f"""
        DELETE FROM retail_bronze.customer_src_raw WHERE extract_date = '{extract_date}' ;
